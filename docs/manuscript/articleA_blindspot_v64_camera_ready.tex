...
\textbf{(S2) Classifier-side:} A Static Random Forest ($\tau_{\mathrm{ARF}} = \infty$) removes the CUSUM tension at a ${\sim}24\%$ post-drift accuracy cost, isolating internal adaptation as the driver.
