...
% Companion treatment, pending the v65 assembly: docs/manuscript/sections/dependence_v2.tex
% (proofs, the counterexample, the RNG gate, the plug-in refutation and the competing-risks form).
...
We therefore state the boundary below in a form that needs \emph{no} dependence hypothesis, and our claims rest on the directly measured adaptation time $\tau_{\mathrm{ARF}}$ (Section~\ref{sec:hydra}), not on the independence formula.
